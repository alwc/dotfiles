...
\newcommand{\px}[1]{\bm{x}^{(#1)}} % maybe change px to ix
\newcommand{\py}[1]{\bm{y}^{(#1)}}
...
\newcommand{\mLambda}[0]{\bm{\Lambda}}
\newcommand{\mOmega}[0]{\bm{\Omega}}
\newcommand{\mSigma}[0]{\bm{\Sigma}}
\newcommand{\mTheta}[0]{\bm{\Theta}}
...
\newcommand{\valpha}[0]{\bm{\alpha}}
\newcommand{\vbeta}[0]{\bm{\beta}}
\newcommand{\vgamma}[0]{\bm{\gamma}}
\newcommand{\vmu}[0]{\bm{\mu}}
\newcommand{\vpi}[0]{\bm{\pi}}
\newcommand{\vphi}[0]{\bm{\phi}}
\newcommand{\vsigma}[0]{\bm{\sigma}}
\newcommand{\vepsilon}[0]{\bm{\epsilon}}
\newcommand{\vtheta}[0]{\bm{\theta}}
\newcommand{\vvarphi}[0]{\bm{\varphi}}
...
\newcommand{\maxr}[2]{
\max_{\scriptsize \begin{array}{c}{#1}\\{#2}\end{array}}
} % max with 2 rows
\newcommand{\minr}[2]{
\min_{\scriptsize \begin{array}{c}{#1}\\{#2}\end{array}}
} % min with 2 rows
\newcommand{\amaxr}[2]{
\amax_{\scriptsize \begin{array}{c}{#1}\\{#2}\end{array}}
} % max with 2 rows
\newcommand{\amax}{\mathop{\mathrm{argmax}}}
...
%%% Minted
\newcommand{\textpy}[1]{{\mintinline{python}{#1}}}
...
\newcommand{\brn}[1]{{\color{brown}#1}}
\newcommand{\gry}[1]{{\color{gray}#1}}
\newcommand{\olv}[1]{{\color{olive}#1}}
\newcommand{\pnk}[1]{{\color{pink}#1}}
\newcommand{\lme}[1]{{\color{lime}#1}}
\newcommand{\ylw}[1]{{\color{yellow}#1}}

\newcommand{\bhref}[2]{{\color{blue}\href{#1}{#2}}}
...
\newcommand{\sumim}[0]{\sum_{i=1}^{m}}
\newcommand{\sumjn}[0]{\sum_{j=1}^{n}}
\newcommand{\prodin}[0]{\prod_{i=1}^{n}}
...
\newcommand{\bcset}[3]{\left\{ {#1}_{#2}, \ldots, {#1}_{#3} \right\}}
\newcommand{\seq}[2]{{#1}_1, {#1}_2, \ldots, {#1}_{#2}}

%%% Brackets and Parentheses
%%% TODO: https://tex.stackexchange.com/questions/2607/spacing-around-left-and-right/
\newcommand{\norm}[1]{\left\| #1 \right\|}
...
%%% Markup
\newcommand{\src}[1]{\textbf{Source: }#1}
...
\newcommand{\iiiy}[0]{\int_{-\infty}^{\infty}}
